...
const addUserToSchedulerFilter = (id, schedulerId) => ({
  type: ActionTypes.USER_TO_SCHEDULER_FILTER_ADD,
  payload: {
    id,
    schedulerId,
  },
...
const removeUserFromSchedulerFilter = (id, schedulerId) => ({
  type: ActionTypes.USER_FROM_SCHEDULER_FILTER_REMOVE,
  payload: {
    id,
    schedulerId,
  },
