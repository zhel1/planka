...
export default {
  ...
  translation: {
    common: {
      ...
      createScheduler: 'Создание календаря',
      ...
      enterSchedulerTitle: 'Введите название календаря',
      ...
      general: 'Основные',
      hours: 'Часы',
      impossibleAction: 'Данное действие запрещено для LDAP аккаунтов',
      ...
      allDay: 'Весь день',
      repeatThisEvent: 'Повторять это событие',
      repeatEvery: 'Повторять каждый(-ую)',
      day: 'день',
      week: 'неделю',
      month: 'месяц',
      year: 'год',
      ...
      weekendDay: 'выходной',
      weekDay: 'будний день',
      endRepeat: 'Закончить повторять',
      never: 'Никогда',
      afterSeveralOccurrences: 'После нескольких повторений',
      allEventsFor: 'Все события на',
      projects: 'Проекты',
      schedulers: 'Календари',
      today: 'Сегодня',
      statisticFor: 'Статистика за',
      events: 'соб.',
      noEventsForSelectedDate: 'Нет событий за выбранную дату',
    ...
    action: {
      ...
      addUser: 'Добавить локального пользователя',
      ...
      createScheduler: 'Создать календарь',
      delete: 'Удалить',
