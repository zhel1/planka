export default {
  ...
  LOCATION_CHANGE_HANDLE__SCHEDULER_FETCH: 'LOCATION_CHANGE_HANDLE__SCHEDULER_FETCH',
  ...
  USER_TO_SCHEDULER_FILTER_ADD: 'USER_TO_SCHEDULER_FILTER_ADD', // TODO* IS THIS USED?
  USER_FROM_SCHEDULER_FILTER_REMOVE: 'USER_FROM_SCHEDULER_FILTER_REMOVE', // TODO* IS THIS USED?
  ...
  SCHEDULER_CREATE__SUCCESS: 'SCHEDULER_CREATE__SUCCESS',
  SCHEDULER_CREATE__FAILURE: 'SCHEDULER_CREATE__FAILURE',
  SCHEDULER_CREATE_HANDLE: 'SCHEDULER_CREATE_HANDLE',
  SCHEDULER_UPDATE: 'SCHEDULER_UPDATE',
  SCHEDULER_UPDATE__SUCCESS: 'SCHEDULER_UPDATE__SUCCESS',
  SCHEDULER_UPDATE__FAILURE: 'SCHEDULER_UPDATE__FAILURE',
  SCHEDULER_UPDATE_HANDLE: 'SCHEDULER_UPDATE_HANDLE',
  SCHEDULER_BACKGROUND_IMAGE_UPDATE: 'SCHEDULER_BACKGROUND_IMAGE_UPDATE',
  SCHEDULER_BACKGROUND_IMAGE_UPDATE__SUCCESS: 'SCHEDULER_BACKGROUND_IMAGE_UPDATE__SUCCESS',
  SCHEDULER_BACKGROUND_IMAGE_UPDATE__FAILURE: 'SCHEDULER_BACKGROUND_IMAGE_UPDATE__FAILURE',
  SCHEDULER_DELETE: 'SCHEDULER_DELETE',
  SCHEDULER_DELETE__SUCCESS: 'SCHEDULER_DELETE__SUCCESS',
  SCHEDULER_DELETE__FAILURE: 'SCHEDULER_DELETE__FAILURE',
  SCHEDULER_DELETE_HANDLE: 'SCHEDULER_DELETE_HANDLE',
  // test
  // SCHEDULER_FETCH: 'SCHEDULER_FETCH',
  // SCHEDULER_FETCH__SUCCESS: 'SCHEDULER_FETCH__SUCCESS',
  // SCHEDULER_FETCH__FAILURE: 'SCHEDULER_FETCH__FAILURE',
  // test
  SCHEDULER_STATE_UPDATE: 'SCHEDULER_STATE_UPDATE',

  /* Scheduler managers */

  SCHEDULER_MANAGER_CREATE: 'SCHEDULER_MANAGER_CREATE',
  SCHEDULER_MANAGER_CREATE__SUCCESS: 'SCHEDULER_MANAGER_CREATE__SUCCESS',
  SCHEDULER_MANAGER_CREATE__FAILURE: 'SCHEDULER_MANAGER_CREATE__FAILURE',
  SCHEDULER_MANAGER_CREATE_HANDLE: 'SCHEDULER_MANAGER_CREATE_HANDLE',
  SCHEDULER_MANAGER_CREATE_HANDLE__SCHEDULER_FETCH:
    'SCHEDULER_MANAGER_CREATE_HANDLE__SCHEDULER_FETCH',
  SCHEDULER_MANAGER_DELETE: 'SCHEDULER_MANAGER_DELETE',
  SCHEDULER_MANAGER_DELETE__SUCCESS: 'SCHEDULER_MANAGER_DELETE__SUCCESS',
  SCHEDULER_MANAGER_DELETE__FAILURE: 'SCHEDULER_MANAGER_DELETE__FAILURE',
  SCHEDULER_MANAGER_DELETE_HANDLE: 'SCHEDULER_MANAGER_DELETE_HANDLE',

  /* Scheduler memberships */

  SCHEDULER_MEMBERSHIP_CREATE: 'SCHEDULER_MEMBERSHIP_CREATE',
  SCHEDULER_MEMBERSHIP_CREATE__SUCCESS: 'SCHEDULER_MEMBERSHIP_CREATE__SUCCESS',
  SCHEDULER_MEMBERSHIP_CREATE__FAILURE: 'SCHEDULER_MEMBERSHIP_CREATE__FAILURE', // ?TODO*
  SCHEDULER_MEMBERSHIP_CREATE_HANDLE: 'SCHEDULER_MEMBERSHIP_CREATE_HANDLE',
  SCHEDULER_MEMBERSHIP_CREATE_HANDLE__SCHEDULER_FETCH:
    'SCHEDULER_MEMBERSHIP_CREATE_HANDLE__SCHEDULER_FETCH', // ?TODO*
  SCHEDULER_MEMBERSHIP_UPDATE: 'SCHEDULER_MEMBERSHIP_UPDATE',
  SCHEDULER_MEMBERSHIP_UPDATE__SUCCESS: 'SCHEDULER_MEMBERSHIP_UPDATE__SUCCESS',
  SCHEDULER_MEMBERSHIP_UPDATE__FAILURE: 'SCHEDULER_MEMBERSHIP_UPDATE__FAILURE', // ?TODO*
  SCHEDULER_MEMBERSHIP_UPDATE_HANDLE: 'SCHEDULER_MEMBERSHIP_UPDATE_HANDLE',
  SCHEDULER_MEMBERSHIP_DELETE: 'SCHEDULER_MEMBERSHIP_DELETE',
  SCHEDULER_MEMBERSHIP_DELETE__SUCCESS: 'SCHEDULER_MEMBERSHIP_DELETE__SUCCESS',
  SCHEDULER_MEMBERSHIP_DELETE__FAILURE: 'SCHEDULER_MEMBERSHIP_DELETE__FAILURE', // ?TODO*
  SCHEDULER_MEMBERSHIP_DELETE_HANDLE: 'SCHEDULER_MEMBERSHIP_DELETE_HANDLE',

  /* Scheduler labels */

  SCHEDULER_LABEL_CREATE: 'SCHEDULER_LABEL_CREATE',
  SCHEDULER_LABEL_CREATE__SUCCESS: 'SCHEDULER_LABEL_CREATE__SUCCESS',
  SCHEDULER_LABEL_CREATE__FAILURE: 'SCHEDULER_LABEL_CREATE__FAILURE',
  SCHEDULER_LABEL_CREATE_HANDLE: 'SCHEDULER_LABEL_CREATE_HANDLE',
  SCHEDULER_LABEL_UPDATE: 'SCHEDULER_LABEL_UPDATE',
  SCHEDULER_LABEL_UPDATE__SUCCESS: 'SCHEDULER_LABEL_UPDATE__SUCCESS',
  SCHEDULER_LABEL_UPDATE__FAILURE: 'SCHEDULER_LABEL_UPDATE__FAILURE',
  SCHEDULER_LABEL_UPDATE_HANDLE: 'SCHEDULER_LABEL_UPDATE_HANDLE',
  SCHEDULER_LABEL_DELETE: 'SCHEDULER_LABEL_DELETE',
  SCHEDULER_LABEL_DELETE__SUCCESS: 'SCHEDULER_LABEL_DELETE__SUCCESS',
  SCHEDULER_LABEL_DELETE__FAILURE: 'SCHEDULER_LABEL_DELETE__FAILURE',
  SCHEDULER_LABEL_DELETE_HANDLE: 'SCHEDULER_LABEL_DELETE_HANDLE',
  // SCHEDULER_LABEL_TO_CARD_ADD: 'SCHEDULER_LABEL_TO_CARD_ADD',
  // SCHEDULER_LABEL_TO_CARD_ADD__SUCCESS: 'SCHEDULER_LABEL_TO_CARD_ADD__SUCCESS',
  // SCHEDULER_LABEL_TO_CARD_ADD__FAILURE: 'SCHEDULER_LABEL_TO_CARD_ADD__FAILURE',
  // SCHEDULER_LABEL_TO_CARD_ADD_HANDLE: 'SCHEDULER_LABEL_TO_CARD_ADD_HANDLE',
  // SCHEDULER_LABEL_FROM_CARD_REMOVE: 'SCHEDULER_LABEL_FROM_CARD_REMOVE',
  // SCHEDULER_LABEL_FROM_CARD_REMOVE__SUCCESS: 'SCHEDULER_LABEL_FROM_CARD_REMOVE__SUCCESS',
  // SCHEDULER_LABEL_FROM_CARD_REMOVE__FAILURE: 'SCHEDULER_LABEL_FROM_CARD_REMOVE__FAILURE',
  // SCHEDULER_LABEL_FROM_CARD_REMOVE_HANDLE: 'SCHEDULER_LABEL_FROM_CARD_REMOVE_HANDLE',
  SCHEDULER_LABEL_TO_SCHEDULER_FILTER_ADD: 'SCHEDULER_LABEL_TO_SCHEDULER_FILTER_ADD',
  SCHEDULER_LABEL_FROM_SCHEDULER_FILTER_REMOVE: 'SCHEDULER_LABEL_FROM_SCHEDULER_FILTER_REMOVE',

  /* Scheduler events */

  SCHEDULER_EVENT_CREATE: 'SCHEDULER_EVENT_CREATE',
  SCHEDULER_EVENT_CREATE__SUCCESS: 'SCHEDULER_EVENT_CREATE__SUCCESS',
  SCHEDULER_EVENT_CREATE__FAILURE: 'SCHEDULER_EVENT_CREATE__FAILURE',
  SCHEDULER_EVENT_CREATE_HANDLE: 'SCHEDULER_EVENT_CREATE_HANDLE',
  SCHEDULER_EVENT_FETCH: 'SCHEDULER_EVENT_FETCH',
  SCHEDULER_EVENT_FETCH__SUCCESS: 'SCHEDULER_EVENT_FETCH__SUCCESS',
  SCHEDULER_EVENT_FETCH__FAILURE: 'SCHEDULER_EVENT_FETCH__FAILURE',
  SCHEDULER_EVENT_UPDATE: 'SCHEDULER_EVENT_UPDATE',
  SCHEDULER_EVENT_UPDATE__SUCCESS: 'SCHEDULER_EVENT_UPDATE__SUCCESS',
  SCHEDULER_EVENT_UPDATE__FAILURE: 'SCHEDULER_EVENT_UPDATE__FAILURE',
  SCHEDULER_EVENT_UPDATE_HANDLE: 'SCHEDULER_EVENT_UPDATE_HANDLE',
  SCHEDULER_EVENT_TRANSFER: 'SCHEDULER_EVENT_TRANSFER',
  SCHEDULER_EVENT_TRANSFER__SUCCESS: 'SCHEDULER_EVENT_TRANSFER__SUCCESS',
  SCHEDULER_EVENT_TRANSFER__FAILURE: 'SCHEDULER_EVENT_TRANSFER__FAILURE',
  SCHEDULER_EVENT_DELETE: 'SCHEDULER_EVENT_DELETE',
  SCHEDULER_EVENT_DELETE__SUCCESS: 'SCHEDULER_EVENT_DELETE__SUCCESS',
  SCHEDULER_EVENT_DELETE__FAILURE: 'SCHEDULER_EVENT_DELETE__FAILURE',
  SCHEDULER_EVENT_DELETE_HANDLE: 'SCHEDULER_EVENT_DELETE_HANDLE',
