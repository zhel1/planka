...
export default {
  ...
  USER_TO_FILTER_IN_CURRENT_SCHEDULER_ADD: `${PREFIX}/USER_TO_FILTER_IN_CURRENT_SCHEDULER_ADD`,
  USER_FROM_FILTER_IN_CURRENT_SCHEDULER_REMOVE: `${PREFIX}/USER_FROM_FILTER_IN_CURRENT_SCHEDULER_REMOVE`,

  /* Scheduler */

  SCHEDULER_CREATE: `${PREFIX}/SCHEDULER_CREATE`,
  SCHEDULER_CREATE_HANDLE: `${PREFIX}/SCHEDULER_CREATE_HANDLE`,
  CURRENT_SCHEDULER_UPDATE: `${PREFIX}/CURRENT_SCHEDULER_UPDATE`,
  SCHEDULER_UPDATE_HANDLE: `${PREFIX}/SCHEDULER_UPDATE_HANDLE`,
  CURRENT_SCHEDULER_BACKGROUND_IMAGE_UPDATE: `${PREFIX}/CURRENT_SCHEDULER_BACKGROUND_IMAGE_UPDATE`,
  CURRENT_SCHEDULER_DELETE: `${PREFIX}/CURRENT_SCHEDULER_DELETE`,
  SCHEDULER_DELETE_HANDLE: `${PREFIX}/SCHEDULER_DELETE_HANDLE`,

  // not in orm
  SCHEDULER_STATE_UPDATE: `${PREFIX}/SCHEDULER_STATE_UPDATE`,

  /* Scheduler managers */

  MANAGER_IN_CURRENT_SCHEDULER_CREATE: `${PREFIX}/MANAGER_IN_CURRENT_SCHEDULER_CREATE`,
  SCHEDULER_MANAGER_CREATE_HANDLE: `${PREFIX}/SCHEDULER_MANAGER_CREATE_HANDLE`,
  SCHEDULER_MANAGER_DELETE: `${PREFIX}/SCHEDULER_MANAGER_DELETE`,
  SCHEDULER_MANAGER_DELETE_HANDLE: `${PREFIX}/SCHEDULER_MANAGER_DELETE_HANDLE`,

  /* Scheduler memberships */

  MEMBERSHIP_IN_CURRENT_SCHEDULER_CREATE: `${PREFIX}/MEMBERSHIP_IN_CURRENT_SCHEDULER_CREATE`,
  SCHEDULER_MEMBERSHIP_CREATE_HANDLE: `${PREFIX}/SCHEDULER_MEMBERSHIP_CREATE_HANDLE`,
  SCHEDULER_MEMBERSHIP_UPDATE: `${PREFIX}/SCHEDULER_MEMBERSHIP_UPDATE`,
  SCHEDULER_MEMBERSHIP_UPDATE_HANDLE: `${PREFIX}/SCHEDULER_MEMBERSHIP_UPDATE_HANDLE`,
  SCHEDULER_MEMBERSHIP_DELETE: `${PREFIX}/SCHEDULER_MEMBERSHIP_DELETE`,
  SCHEDULER_MEMBERSHIP_DELETE_HANDLE: `${PREFIX}/SCHEDULER_MEMBERSHIP_DELETE_HANDLE`,

  /* Scheduler labels */

  SCHEDULER_LABEL_IN_CURRENT_SCHEDULER_CREATE: `${PREFIX}/SCHEDULER_LABEL_IN_CURRENT_SCHEDULER_CREATE`,
  SCHEDULER_LABEL_CREATE_HANDLE: `${PREFIX}/SCHEDULER_LABEL_CREATE_HANDLE`,
  SCHEDULER_LABEL_UPDATE: `${PREFIX}/SCHEDULER_LABEL_UPDATE`,
  SCHEDULER_LABEL_UPDATE_HANDLE: `${PREFIX}/SCHEDULER_LABEL_UPDATE_HANDLE`,
  SCHEDULER_LABEL_MOVE: `${PREFIX}/SCHEDULER_LABEL_MOVE`,
  SCHEDULER_LABEL_DELETE: `${PREFIX}/SCHEDULER_LABEL_DELETE`,
  SCHEDULER_LABEL_DELETE_HANDLE: `${PREFIX}/SCHEDULER_LABEL_DELETE_HANDLE`,
  // SCHEDULER_LABEL_TO_CARD_ADD: `${PREFIX}/SCHEDULER_LABEL_TO_CARD_ADD`,
  // SCHEDULER_LABEL_TO_CURRENT_CARD_ADD: `${PREFIX}/SCHEDULER_LABEL_TO_CURRENT_CARD_ADD`,
  // SCHEDULER_LABEL_TO_CARD_ADD_HANDLE: `${PREFIX}/SCHEDULER_LABEL_TO_CARD_ADD_HANDLE`,
  // SCHEDULER_LABEL_FROM_CARD_REMOVE: `${PREFIX}/SCHEDULER_LABEL_FROM_CARD_REMOVE`,
  // SCHEDULER_LABEL_FROM_CURRENT_CARD_REMOVE: `${PREFIX}/SCHEDULER_LABEL_FROM_CURRENT_CARD_REMOVE`,
  // SCHEDULER_LABEL_FROM_CARD_REMOVE_HANDLE: `${PREFIX}/SCHEDULER_LABEL_FROM_CARD_REMOVE_HANDLE`,
  SCHEDULER_LABEL_TO_FILTER_IN_CURRENT_SCHEDULER_ADD: `${PREFIX}/SCHEDULER_LABEL_TO_FILTER_IN_CURRENT_SCHEDULER__ADD`,
  SCHEDULER_LABEL_FROM_FILTER_IN_CURRENT_SCHEDULER_REMOVE: `${PREFIX}/SCHEDULER_LABEL_FROM_FILTER_IN_CURRENT_SCHEDULER_REMOVE`,

  /* Scheduler events */
  SCHEDULER_EVENT_CREATE: `${PREFIX}/SCHEDULER_EVENT_CREATE`,
  SCHEDULER_EVENT_CREATE_HANDLE: `${PREFIX}/SCHEDULER_EVENT_CREATE_HANDLE`,
  SCHEDULER_EVENT_UPDATE: `${PREFIX}/SCHEDULER_EVENT_UPDATE`,
  CURRENT_SCHEDULER_EVENT_UPDATE: `${PREFIX}/CURRENT_SCHEDULER_EVENT_UPDATE`,
  SCHEDULER_EVENT_UPDATE_HANDLE: `${PREFIX}/SCHEDULER_EVENT_UPDATE_HANDLE`,
  // SCHEDULER_EVENT_MOVE: `${PREFIX}/SCHEDULER_EVENT_MOVE`,
  // CURRENT_SCHEDULER_EVENT_MOVE: `${PREFIX}/CURRENT_SCHEDULER_EVENT_MOVE`,
  SCHEDULER_EVENT_TRANSFER: `${PREFIX}/SCHEDULER_EVENT_TRANSFER`,
  CURRENT_SCHEDULER_EVENT_TRANSFER: `${PREFIX}/CURRENT_SCHEDULER_EVENT_TRANSFER`,
  SCHEDULER_EVENT_DELETE: `${PREFIX}/SCHEDULER_EVENT_DELETE`,
  CURRENT_SCHEDULER_EVENT_DELETE: `${PREFIX}/CURRENT_SCHEDULER_EVENT_DELETE`,
  SCHEDULER_EVENT_DELETE_HANDLE: `${PREFIX}/SCHEDULER_EVENT_DELETE_HANDLE`,
